...
wget -q -O /usr/local/bin/edu-ssh https://raw.githubusercontent.com/febrystores/ScriptPremium01/main/proxy-template.py
...
wget -q -O /usr/local/bin/edu-ovpn https://raw.githubusercontent.com/febrystores/ScriptPremium01/main/edu-op.py
